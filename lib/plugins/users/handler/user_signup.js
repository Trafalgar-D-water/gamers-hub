...
module.exports = async (request, h) => {
  ...
  try {
    ...
    const CreateProfileForUser = await server.methods.add_user_while_singup_in_profile(newUser._id , username);
    console.log(CreateProfileForUser);
    ...
    const baseURL = process.env.BASE_URL || 'http://localhost:3000/'; // Default to local development
